      ...
      <div class="row pt-10">
        ...
        <div class="col-lg-8 col-md-11">
          <div class="d-flex">
            ...
            <div class="ms-auto">
              <img class="w-50 float-end mt-lg-n4" src={{ asset('assets/img/small-logos/icon-sun-cloud.png') }} alt="image sun">
            </div>
          </div>
          <div class="row mt-4">
            ...
            <div class="col-lg-4 col-md-4 mt-4 mt-sm-0">
              <div class="card card-background card-background-mask-primary move-on-hover align-items-start">
                <div class="cursor-pointer">
                  <div class="full-background" style="background-image: url({{ asset('assets/img/curved-images/curved1.jpg') }})"></div>
                  <div class="card-body">
