...
@section('content')
  ...
  <section class="min-vh-100 mb-8">
    <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg" style="background-image: url({{ asset('assets/img/curved-images/curved_bg.jpg') }});">
    </div>
    <div class="container">
          ...
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form text-left" method="POST" action="/register">
                ...
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="login" class="text-info font-weight-bold">Sign in</a></p>
              </form>
            </div>
          </div>
        </div>
